<template>
    <div id="mainAllOrderList" v-if="this.messageAer=='COMMON'">
        <s1t :key="'cus_'+index" v-for="(item,index) in ListInfo" :eachinfo="ListInfo[index]" :type='this.messageAer'></s1t>
        <div v-show="ListInfo.length==0" style="width:100%;line-height:50px;text-align:center;color:#666666">· 你还没有可用订单哦 ·</div>
    </div>
