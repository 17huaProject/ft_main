<template>
  <div id="main_ds">
    ...
    <div class="OrderListArea">
      <alllist v-show="childShow[0]" :messageAer='"GOODS"'></alllist>
      <needpay v-show="childShow[1]" :messageAer='"GOODS"'></needpay>
      <!-- <canuses v-show="childShow[2]" :messageAer='"GOODS"'></canuses> -->
      <payouts v-show="childShow[3]" :messageAer='"GOODS"'></payouts>
    </div>
  </div>
</template>
