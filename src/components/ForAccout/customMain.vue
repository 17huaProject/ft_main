<template>
    <div id="tamMain">
        ...
        <img id="titleImg" src="//image.17hua.me/upload/image/201711/1511750098646727.png">
        <div id="manTia">
            <div>定制活动</div>
        </div>
        <div id="manTia_Tschild">与朋友一起共度享受难忘之夜吧！ 我们为您提供专业化定制服务，在这里您将充分发挥创造力，并展现您独特的天赋。</div>
        <div class="mass_info">
            <div class="mass_title">私人活动定制</div>
            <div class="mass_text">邀请20至200位好朋友参加一场值得回忆的主题派对，举起香醇的红酒，为单身、为生日、为即将诞生的宝宝而庆祝吧！</div>
            <img class="mass_img" src="//image.17hua.me/upload/image/201711/1511750099230375.png"  @click="routerGo('/cpr')">
            <div class="mass_more" @click="routerGo('/cpr')">MORE ></div>
        </div>
        <div class="mass_info">
            <div class="mass_title">团建活动定制</div>
            <div class="mass_text">司聚会不一定只有唱歌吃饭，在轻松愉悦的绘画活动中，加深相互认识了解，体验创意和乐趣、加强社团团队凝聚力。</div>
            <img class="mass_img" src="//image.17hua.me/upload/image/201711/1511750099210475.png"  @click="routerGo('/cpu')">
            <div class="mass_more" @click="routerGo('/cpu')">MORE ></div>
        </div>
